...
const FeedbackPage = () => {
  const posterSrc = "/bisik.svg";
  const posterTitle = "BISIK BINCANG ASIK";
  const likeCount = 320;
  const commentCount = 45;
  const description = "Acara Bisik memberikan pengalaman yang berharga, membangun wawasan, dan memberikan inspirasi luar biasa kepada semua peserta.";
