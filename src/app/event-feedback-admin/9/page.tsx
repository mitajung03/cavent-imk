import AllFeedback from '../../components/allfeedback-admin';

const FeedbackPage = () => {
  const posterSrc = "/green-campus-dkm.svg";
  const posterTitle = "GREEN CAMPUS";
  const likeCount = 320;
  const commentCount = 45;
  const description = "Acara Green Campus memberikan pengalaman yang berharga, membangun wawasan, dan memberikan inspirasi luar biasa kepada semua peserta.";
  const postTime = "Posted 2 days ago";
