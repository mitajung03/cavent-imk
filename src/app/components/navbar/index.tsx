    ...
    <div className="fixed bottom-0 mx-auto w-full max-w-[393px] left-1/2 transform -translate-x-1/2 items-center bg-white border border-gray-300">
      ...
      <button
        ...
        className={`flex flex-col items-center ${
          currentPath === '/notification' ? 'text-cyan-600' : 'text-gray-600 hover:text-cyan-600'
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center ${
          currentPath === '/homepage' ? 'text-cyan-600' : 'text-gray-600 hover:text-cyan-600'
        }`}
      >
      ...
      <button
        ...
        className={`flex flex-col items-center ${
          currentPath === '/profile' ? 'text-cyan-600' : 'text-gray-600 hover:text-cyan-600'
        }`}
      >
